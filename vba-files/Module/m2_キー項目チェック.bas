Attribute VB_Name = "m2_キー項目チェック"
Option Explicit
' --------------------------------------+-----------------------------------------
' | @function   : キー項目の重複およびNull値を検出（モジュール分割版）
' --------------------------------------+-----------------------------------------
' | @moduleName : m2_キー項目チェック
' | @Version    : v1.0.0
' | @update     : 2023/05/16
' | @written    : 2023/05/16
' | @author     : Jun Fujinawa
...
Public Sub キー項目チェック_R(ByVal dummy As Variant)
' --------------------------------------+-----------------------------------------
' | @function   : キー項目に矛盾がないかチェックする
' --------------------------------------+-----------------------------------------
' | @moduleName : キー項目チェック_R
' | @Version    : v1.0.0
' | @update     : 2023/05/16
' | @written    : 2023/05/16
' | @remarks
